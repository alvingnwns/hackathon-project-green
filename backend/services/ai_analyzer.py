...
prompt = """
        ...
        8. Proportional Scaling Reasoning: Sebelum melakukan penentuan nilai `scale_3d` pada objek-objek lain (selain lahan), lakukan PERBANDINGAN UKURAN (Reasoning) secara logis! Objek terbesar (misal Gazebo/Rumah Kaca) mungkin memiliki skala 2.0 atau 3.0. Objek skala menengah (misal Panel Surya) sekitar 1.2 hingga 1.5. Objek kecil (seperti Tong Sampah, Tanaman kecil) WAJIB dibuat jauh lebih kecil, misalnya 0.15 hingga 0.3. Dilarang memberikan skala yang hampir sama untuk objek yang berbeda ukuran secara fisik!
